...
function parse_network(data){
    ...
    const name = network_data.set('name', data.network.name);
    const city = network_data.set('city', data.network.location.city);
    const latitude = network_data.set('latitude', data.network.location.latitude);
    const longitude = network_data.set('longitude', data.network.location.longitude);
